		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-examplenavbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<li><a href="<?php echo base_url().'admin/mobil'; ?>"><img src="<?php echo base_url('assets/glyphicon/glyphicons-car.png');?>" width="20" height="16"/> Data Mobil </a></li>
					<li><a href="<?php echo base_url().'admin/pelanggan'; ?>"><span class="glyphicon glyphicon-user"></span> Data Pelangan </a></li>
					<li><a href="<?php echo base_url().'admin/rental'; ?>"><span class="glyphicon glyphicon-sort"></span> Transaksi Peminjaman </a></li>
